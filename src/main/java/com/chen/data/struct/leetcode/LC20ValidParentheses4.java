 ...
 * 结果：通过 	22 ms	36.4 MB
 */
public class LC20ValidParentheses4 {
    ...
    private class DummyHeadList<E> implements List<E>{
        private class Node{
            private E e;
            private Node next;
    ...
    public static void main(String[] args) {
        String demo1 = "()[]{}";
        boolean result = new LC20ValidParentheses4().isValid(demo1);
        System.out.println(result);

        String demo2 = "(]";
        System.out.println(new LC20ValidParentheses4().isValid(demo2));

        String demo3 = "}{";
        System.out.println(new LC20ValidParentheses4().isValid(demo3));
    }
}
